var GAME_CATALOG = [
  {
    ...
    roadmap: {
      ...
      time: '15–20 Hours',
      playthroughs: '1 Playthrough + Chapter Select',
      missable: '0 Missable (Chapter Select available)',
      summary: 'Platinum can be completed on any difficulty (including Very Light). The list integrates the Left Behind DLC into a single 29-trophy set.'
    },
    achievements: [
      {
        id: 'tlou-01',
  ...
  },
  {
    ...
    roadmap: {
      difficulty: '3/10',
      difficultyLabel: 'Very Accessible',
      time: '45–55 Hours',
      playthroughs: '1 Playthrough',
      missable: '0 Missable (Free roam after story)',
      summary: 'Free all of Tsushima, liberate all Mongol territories, honor all Inari Shrines, write all Haiku, and unlock the iconic Cooper Clan Cosplayer armor.'
    },
    achievements: [
      {
        id: 'got-01',
  ...
  },
  {
    ...
    roadmap: {
      ...
      time: '60–80 Hours',
      playthroughs: '1–3 Playthroughs (Save Backup possible for Endings)',
      missable: 'Several (Bolt of Gransax before Ashen Capital)',
      summary: '42 achievements covering all major demigods, legendary gear, and 3 ending variants: Elden Lord, Age of the Stars, and Lord of Frenzied Flame.'
    },
    achievements: [
      {
        id: 'er-01',
  ...
  },
  {
    ...
    roadmap: {
      ...
      time: '60–75 Hours',
      playthroughs: '1 Playthrough (Save point before Nocturne Op55N1)',
      missable: 'Missable (Takemura rescue in Search and Destroy)',
      summary: 'Explore Night City, clear all NCPD scanner hustles and gigs across all districts, achieve all 5 ending epilogues, and craft legendary gear.'
    },
    achievements: [
      {
        id: 'cp-01',
  ...
  },
  {
    ...
    roadmap: {
      ...
      time: '35–45 Hours',
      playthroughs: '1 Playthrough',
      missable: '0 Missable (Post-game free roam)',
      summary: 'Complete Kratos and Atreus journey through Midgard, defeat all 9 Valkyries including Sigrun, clear Niflheim and Muspelheim.'
    },
    achievements: [
      {
        id: 'gow-01',
  ...
  },
  {
    ...
    roadmap: {
      ...
      time: '45–60 Hours',
      playthroughs: '1–3 Playthroughs (Save Backup for 3 Endings)',
      missable: 'Several (Eileen the Crow, Cord of Eyes, Chalice Dungeons)',
      summary: 'Survive the Hunt in Yharnam, uncover the eldritch truth of the Great Ones, collect all hunter weapons, and defeat Queen Yharnam in the Pthumeru Ihyll Chalice.'
    },
    achievements: [
      {
        id: 'bb-01',
  ...
  },
  {
    ...
    roadmap: {
      difficulty: '3/10',
      difficultyLabel: 'Easy & Enjoyable',
      time: '25–30 Hours',
      playthroughs: '1 Playthrough',
      missable: '0 Missable',
      summary: 'Swing through Manhattan, unlock all 28 suits, clear all district crimes, landmarks, and defeat the Sinister Six.'
    },
    achievements: [
      {
        id: 'sp-01',
...
function getCatalogGame(id) {
  for (var i = 0; i < GAME_CATALOG.length; i++) {
    if (GAME_CATALOG[i].id === id) return GAME_CATALOG[i];
  }
  return null;
}
