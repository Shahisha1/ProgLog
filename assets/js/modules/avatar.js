...
export const GAME_CHARACTER_IMAGES = {
  kratos:
    "https://vignette.wikia.nocookie.net/godofwar/images/5/52/Kratos.png/revision/latest?cb=20180220162022",
  ...
  geralt:
    "https://assetsio.gnwcdn.com/the-witcher-3-eleito-o-jogo-do-ano-nos-the-game-awards-1449201813732.jpg?auto=webp&enable=upscale&fit=crop&format=png&height=1200&quality=100&width=1200",
  link: "https://cdn.wikimg.net/en/zeldawiki/images/thumb/3/30/HW_Link_Render.png/1200px-HW_Link_Render.png",
  sonic:
    "https://static.zerochan.net/Sonic.the.Hedgehog.%28Character%29.1024.4209105.webp",
  lara: "https://midia.gruposinos.com.br/_midias/jpg/2016/04/29/photos_of_lara_croft_from_tomb_raider_4-1454636.jpg",
  samus:
    "https://images2.wikia.nocookie.net/__cb20100215035740/metroid/images/5/58/Mprime_07_big.jpg",
  mario:
    "https://i.pinimg.com/474x/a9/07/46/a907462c092ecc710299d978f1d3605b.jpg",
  dante:
    "https://i.pinimg.com/originals/99/85/18/9985183f76e6c81617a5cb2f47ff96e4.jpg",
  "master-chief":
    "https://s3.crackedcdn.com/phpimages/article/2/9/5/829295_800x450.jpg",
  ...
  ellie:
    "https://metagalaxia.com.br/wp-content/uploads/2023/03/Ellie-Williams.webp",
  cloud:
    "https://images.saymedia-content.com/.image/t_share/MTc0NDU3Mzk5ODA4MzcwMDI0/top-5-strongest-characters-in-the-final-fantasy-7-universe.png",
  ...
  "doom-slayer":
    "https://www.pngall.com/wp-content/uploads/15/Doom-Slayer-PNG-Images.png",
  kirby:
    "https://www.smashbros.com/wiiu-3ds/sp/images/character/kirby/main.png",
};
...
export function avatarData(input = {}) {
  ...
  const p = PRESETS.find((x) => x.id === input.preset) || PRESETS[0],
    a = { ...DEFAULT_AVATAR, ...p, ...input };
  const rect = (x, y, w, h, c) =>
    `<rect x="${x}" y="${y}" width="${w}" height="${h}" fill="${esc(c)}"/>`;
  let s = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" shape-rendering="crispEdges">`;
  s +=
    rect(0, 0, 16, 16, a.background) +
    rect(3, 14, 10, 1, "#00000022") +
    rect(4, 4, 8, 8, a.skin) +
    rect(3, 6, 1, 4, a.skin) +
    rect(12, 6, 1, 4, a.skin);
  s +=
    rect(4, 3, 8, 2, a.hair) +
    rect(3, 4, 2, 3, a.hair) +
    rect(11, 4, 2, 3, a.hair) +
    rect(5, 2, 6, 1, a.hair) +
    rect(5, 7, 1, 1, "#16181d") +
    rect(10, 7, 1, 1, "#16181d") +
    rect(7, 8, 2, 1, "#b56f61");
  s +=
    rect(7, 10, 2, 2, a.skin) +
    rect(4, 11, 8, 4, a.shirt) +
    rect(3, 12, 1, 3, a.shirt) +
    rect(12, 12, 1, 3, a.shirt) +
    rect(6, 11, 4, 1, a.accent) +
    rect(7, 12, 2, 2, a.accent);
  if (a.preset === "mage")
    s += rect(12, 2, 2, 1, a.accent) + rect(13, 3, 1, 2, a.accent);
  if (a.preset === "ranger")
    s += rect(2, 9, 1, 3, a.accent) + rect(13, 9, 1, 3, a.accent);
  if (a.preset === "pilot")
    s += rect(5, 3, 6, 1, "#e8e8e8") + rect(4, 4, 8, 1, a.hair);
  if (a.preset === "knight")
    s += rect(3, 7, 1, 4, "#d6d9e1") + rect(12, 7, 1, 4, "#d6d9e1");
  if (a.preset === "builder") s += rect(4, 2, 8, 1, a.accent);
  if (a.preset === "neon")
    s += rect(4, 5, 1, 2, a.accent) + rect(11, 5, 1, 2, a.accent);
