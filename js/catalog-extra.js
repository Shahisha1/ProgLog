...
(function () {
  ...
  var extras = [
    ...
    {id:'horizon-forbidden-west',title:'Horizon Forbidden West',platform:'playstation',color:'#22c7b7',roadmap:{difficulty:'4/10',difficultyLabel:'Moderate',time:'55–70 Hours',playthroughs:'1 Playthrough',missable:'0 Missable',summary:'Explore the Forbidden West, complete story and side content, machine challenges, collectibles, and the Cauldron network.'},totalTrophies:59},
    {id:'spider-man-2',title:"Marvel's Spider-Man 2",platform:'playstation',color:'#f43f5e',roadmap:{difficulty:'3/10',difficultyLabel:'Easy',time:'30–40 Hours',playthroughs:'1 Playthrough',missable:'0 Missable',summary:'Swing across New York, complete the story, side missions, activities, and suit upgrades.'},totalTrophies:42},
    {id:'resident-evil-4-remake',title:'Resident Evil 4',platform:'playstation',color:'#f97316',roadmap:{difficulty:'7/10',difficultyLabel:'Challenging',time:'45–70 Hours',playthroughs:'Multiple',missable:'Several',summary:'Survive the village, castle, and island across multiple difficulty and challenge runs.'},totalTrophies:101},
    ...
    {id:'stray',title:'Stray',platform:'playstation',color:'#f97316',roadmap:{difficulty:'3/10',difficultyLabel:'Easy',time:'8–10 Hours',playthroughs:'1 Playthrough',missable:'Several',summary:'Guide the stray through the walled city, find collectibles, and complete the story and exploration challenges.'},totalTrophies:25},
